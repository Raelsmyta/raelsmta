...
class ProfessorsControllerTest < ActionController::TestCase
  ...
  test "should create professor" do
    assert_difference('Professor.count') do
      post :create, professor: { email: @professor.email, firstname: @professor.firstname, lastname: @professor.lastname, professor_id: @professor.professor_id }
    end
  ...
  test "should update professor" do
    patch :update, id: @professor, professor: { email: @professor.email, firstname: @professor.firstname, lastname: @professor.lastname, professor_id: @professor.professor_id }
    assert_redirected_to professor_path(assigns(:professor))
  end
